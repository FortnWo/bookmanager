...
) ENGINE = InnoDB DEFAULT CHARSET = utf8 ROW_FORMAT = Dynamic COMMENT = '图书分类';
-- 2. 图书信息表
...
CREATE TABLE `book_info` (
  ...
  `class_id` INT(11) DEFAULT NULL COMMENT '分类号',
  `pressmark` INT(11) DEFAULT NULL COMMENT '书架号',
  `state` SMALLINT(6) DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`book_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000001 DEFAULT CHARSET = utf8 ROW_FORMAT = Dynamic COMMENT = '图书信息';
-- 3. 读者信息表
DROP TABLE IF EXISTS `reader_info`;
CREATE TABLE `reader_info` (
  `reader_id` BIGINT(11) NOT NULL COMMENT '卡号',
...
) ENGINE = InnoDB DEFAULT CHARSET = utf8 ROW_FORMAT = Dynamic COMMENT = '读者信息';
-- 4. 用户表
...
CREATE TABLE `lend_list` (
  ...
  `reader_id` BIGINT(11) NOT NULL COMMENT '读者卡号',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2025031501 DEFAULT CHARSET = utf8 ROW_FORMAT = Dynamic COMMENT = '借阅记录';
-- 6. 公告表
...
VALUES (1, '马克思主义'),
  ...
  (22, '综合');
-- announcement
INSERT INTO announcement (content)
VALUES ('暂无公告');
-- ----------------------------
-- 所有表的示例数据统一插入
-- ----------------------------
...
VALUES (
    ...
    '北京十月文艺出版社',
    '9787530216835',
    '东野圭吾长篇小说杰作，中文简体首次出版。 一出没有剧本的舞台剧，为什么能让七个演员赌上全部人生.东野圭吾就是有这样过人的本领，能从充满悬念的案子写出荡气回肠的情感，在极其周密曲折的同时写出人性的黑暗与美丽。 一家与外界隔绝的民宿里，七个演员被要求住满四天，接受导演的考验，但不断有人失踪。难道这并非正常排练，而是有人布下陷阱要杀他们。 那时候我开始喜欢上戏剧和音乐，《大雪中的山庄》一书的灵感就来源于此。我相信这次的诡计肯定会让人大吃一惊。',
    '中文',
    35.00,
    '2017-07-23',
    9,
...
-- user
INSERT INTO `user`
VALUES ('2206010217', '111111', 'user'),
  ('2206010218', '111111', 'user'),
  ('2206010219', '123456', 'user'),
  ('2206010220', '111111', 'user'),
  ('2206010221', '111111', 'user'),
  ('2206010222', '111111', 'user'),
  ('2022025309', '111111', 'user'),
  ('admin', '111111', 'admin');
-- lend_list
...
VALUES (
  '图书馆开放时间',
  '本馆开放时间：周一至周五 9:00-18:00；周六 9:00-12:00；周日闭馆。',
  '馆务手册',
  NOW()
);